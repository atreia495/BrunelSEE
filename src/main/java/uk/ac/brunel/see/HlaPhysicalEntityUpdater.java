 ...
 */
public interface HlaPhysicalEntityUpdater extends HlaHLAobjectRootUpdater {
    ...
    * @return this updater
    */
    HlaPhysicalEntityUpdater sendName();
    ...
    * @return this updater
    */
    HlaPhysicalEntityUpdater setType(String type);
    ...
    * @return this updater
    */
    HlaPhysicalEntityUpdater setStatus(String status);

   /**
    * Send the parentReferenceFrame in this update.
    ...
    * @return this updater
    */
    HlaPhysicalEntityUpdater sendParentReferenceFrame();
    ...
    * @return this updater
    */
    HlaPhysicalEntityUpdater setState(SpaceTimeCoordinateState state);
    ...
    * @return this updater
    */
    HlaPhysicalEntityUpdater setAcceleration(double[/* 3 */] acceleration);
...
projected.
    ...
    * @return this updater
    */
    HlaPhysicalEntityUpdater setRotationalAcceleration(double[/* 3 */] rotationalAcceleration);
    ...
    * @return this updater
    */
    HlaPhysicalEntityUpdater setCenterOfMass(double[/* 3 */] centerOfMass);
    ...
    * @return this updater
    */
    HlaPhysicalEntityUpdater setBodyWrtStructural(AttitudeQuaternion bodyWrtStructural);
