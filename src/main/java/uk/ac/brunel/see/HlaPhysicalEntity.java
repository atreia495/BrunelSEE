 ...
 */
public interface HlaPhysicalEntity extends HlaPhysicalEntityAttributes, HlaObjectInstanceBase {


   /**
    * Tells if this HlaPhysicalEntity object instance is local or remote.
   ...
   /**
    * Tells if this HlaPhysicalEntity is initialized.
    * An object is initialized if all attributes marked with <i>Initialized</i> has a value.
    * <p>
    * The following attributes are required for HlaPhysicalEntity to be initialized:<ul>
    * <li>Name</li>
    * <li>Type</li>
    * <li>ParentReferenceFrame</li>
    * <li>State</li>
    * <li>Acceleration</li>
    * </ul>
    *
   ...
   /**
    * Tells if this HlaPhysicalEntity is within interest.
   ...
   /**
    * Tells if this HlaPhysicalEntity has been removed.
    *
   ...
   /**
    * Gets an immutable snapshot of the HlaPhysicalEntity's attributes.
    * The attributes returned are always the most recent values available
    * for the attributes.
    *
    * @return attribute snapshot.
    */
    HlaPhysicalEntityAttributes getHlaPhysicalEntityAttributes();

   /**
    * Gets an updater.
    * The updater is used to update a set of attributes on the HlaPhysicalEntity in
    * an atomic fashion. The update object may only be used for at most
    * one update.
    *
    * @return updater object.
    */
    HlaPhysicalEntityUpdater getHlaPhysicalEntityUpdater();
    ...
    * To make sure that no attribute updates arrive before adding the listener, use: {@link uk.ac.brunel.see.HlaPhysicalEntityManager#addHlaPhysicalEntityDefaultInstanceListener(HlaPhysicalEntityListener listener)}.
    *
    * @param listener The listener to add.
    */
    void addHlaPhysicalEntityListener(HlaPhysicalEntityListener listener);
    ...
    */
    void removeHlaPhysicalEntityListener(HlaPhysicalEntityListener listener);
    ...
    * This method is idempotent.
    * To make sure that no attribute updates arrive before adding the listener, use: {@link uk.ac.brunel.see.HlaPhysicalEntityManager#addHlaPhysicalEntityDefaultInstanceValueListener(HlaPhysicalEntityValueListener valueListener)}.
    *
    * @param valueListener The valueListener to add.
    */
    void addHlaPhysicalEntityValueListener(HlaPhysicalEntityValueListener valueListener);
    ...
    */
    void removeHlaPhysicalEntityValueListener(HlaPhysicalEntityValueListener valueListener);

   /**
    * Get the HlaFederateId for the federate that created this HlaPhysicalEntity instance
    *
