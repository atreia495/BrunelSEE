 ...
 * <p>
 * Generated by Pitch Developer Studio version 6.4.0
 * <br>
 * Licensed to Hridyanshu Aatreya, Pitch UK P, Project Edition
 * <p>
 ...
 * see <a href="http://jcip.net/annotations/doc/net/jcip/annotations/package-summary.html">jcip.net</a>.
   ...
   /**
    * Connect to a federation. This will connect to the RTI, join and perform publish and subscribe HLA calls.
    ...
    * @throws HlaCredentialsProviderException      if providing credentials failed
    * @throws HlaInvalidCredentialsException       if the credentials are invalid
    * @throws HlaUnauthorizedException             if the credentials were not accepted by the RTI
    */
    ...
    * This will perform the Time Advance Request HLA call.
    *
    * Note that this method is an implicit {@link #evokeAll()} in manual evoke mode, to verify that all
    ...
    * this method will block until a notification is queued.
    *
