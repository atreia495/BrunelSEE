...
public interface HlaPhysicalInterface extends HlaPhysicalInterfaceAttributes, HlaObjectInstanceBase {
    ...
    * To make sure that no attribute updates arrive before adding the listener, use: {@link uk.ac.brunel.see.HlaPhysicalInterfaceManager#addHlaPhysicalInterfaceDefaultInstanceListener(HlaPhysicalInterfaceListener listener)}.
    *
    ...
    * This method is idempotent.
    * To make sure that no attribute updates arrive before adding the listener, use: {@link uk.ac.brunel.see.HlaPhysicalInterfaceManager#addHlaPhysicalInterfaceDefaultInstanceValueListener(HlaPhysicalInterfaceValueListener valueListener)}.
    *
