...
public interface HlaReferenceFrame extends HlaReferenceFrameAttributes, HlaObjectInstanceBase {
    ...
    * To make sure that no attribute updates arrive before adding the listener, use: {@link uk.ac.brunel.see.HlaReferenceFrameManager#addHlaReferenceFrameDefaultInstanceListener(HlaReferenceFrameListener listener)}.
    *
    ...
    * This method is idempotent.
    * To make sure that no attribute updates arrive before adding the listener, use: {@link uk.ac.brunel.see.HlaReferenceFrameManager#addHlaReferenceFrameDefaultInstanceValueListener(HlaReferenceFrameValueListener valueListener)}.
    *
