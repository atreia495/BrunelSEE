...
public final class InertiaMatrixEncoder extends AbstractFixedArrayEncoder<double[]> {


   public InertiaMatrixEncoder() {
      super(InertiaMatrixEncoder.class, 9);
   }

   public InertiaMatrixEncoder(double[] value) {
      this();
      setValue(value);
   }
