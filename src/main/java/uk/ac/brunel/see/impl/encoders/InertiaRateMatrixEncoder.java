...
public final class InertiaRateMatrixEncoder extends AbstractFixedArrayEncoder<double[]> {


   public InertiaRateMatrixEncoder() {
      super(InertiaRateMatrixEncoder.class, 9);
   }

   public InertiaRateMatrixEncoder(double[] value) {
      this();
      setValue(value);
   }
