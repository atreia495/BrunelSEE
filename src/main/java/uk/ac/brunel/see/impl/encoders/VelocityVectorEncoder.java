...
public final class VelocityVectorEncoder extends AbstractFixedArrayEncoder<double[]> {


   public VelocityVectorEncoder() {
      super(VelocityVectorEncoder.class, 3);
   }

   public VelocityVectorEncoder(double[] value) {
      this();
      setValue(value);
   }
