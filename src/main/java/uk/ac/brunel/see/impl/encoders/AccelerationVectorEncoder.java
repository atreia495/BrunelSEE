...
public final class AccelerationVectorEncoder extends AbstractFixedArrayEncoder<double[]> {


   public AccelerationVectorEncoder() {
      super(AccelerationVectorEncoder.class, 3);
   }

   public AccelerationVectorEncoder(double[] value) {
      this();
      setValue(value);
   }
