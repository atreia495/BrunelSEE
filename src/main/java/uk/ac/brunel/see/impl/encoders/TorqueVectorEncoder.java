...
public final class TorqueVectorEncoder extends AbstractFixedArrayEncoder<double[]> {


   public TorqueVectorEncoder() {
      super(TorqueVectorEncoder.class, 3);
   }

   public TorqueVectorEncoder(double[] value) {
      this();
      setValue(value);
   }
