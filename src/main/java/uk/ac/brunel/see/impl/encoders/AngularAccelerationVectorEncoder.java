...
public final class AngularAccelerationVectorEncoder extends AbstractFixedArrayEncoder<double[]> {


   public AngularAccelerationVectorEncoder() {
      super(AngularAccelerationVectorEncoder.class, 3);
   }

   public AngularAccelerationVectorEncoder(double[] value) {
      this();
      setValue(value);
   }
