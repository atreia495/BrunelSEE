...
public final class PositionVectorEncoder extends AbstractFixedArrayEncoder<double[]> {


   public PositionVectorEncoder() {
      super(PositionVectorEncoder.class, 3);
   }

   public PositionVectorEncoder(double[] value) {
      this();
      setValue(value);
   }
