 ...
 */
public interface HlaDynamicalEntityValueListener {
    ...
    *
    * @param dynamicalEntity   The object which is updated.
    ...
    */
    void forceUpdated(HlaDynamicalEntity dynamicalEntity, double[/* 3 */] force, boolean validOldForce, double[/* 3 */] oldForce, HlaTimeStamp timeStamp, HlaLogicalTime logicalTime);
    ...
    * @param logicalTime The logical time when the update was initiated.
    */
    void torqueUpdated(HlaDynamicalEntity dynamicalEntity, double[/* 3 */] torque, boolean validOldTorque, double[/* 3 */] oldTorque, HlaTimeStamp timeStamp, HlaLogicalTime logicalTime);
    ...
    * @param logicalTime The logical time when the update was initiated.
    */
    void massUpdated(HlaDynamicalEntity dynamicalEntity, double mass, boolean validOldMass, double oldMass, HlaTimeStamp timeStamp, HlaLogicalTime logicalTime);
    ...
    * @param logicalTime The logical time when the update was initiated.
    */
    void massRateUpdated(HlaDynamicalEntity dynamicalEntity, double massRate, boolean validOldMassRate, double oldMassRate, HlaTimeStamp timeStamp, HlaLogicalTime logicalTime);
    ...
    * @param logicalTime The logical time when the update was initiated.
    */
    void inertiaUpdated(HlaDynamicalEntity dynamicalEntity, double[/* 9 */] inertia, boolean validOldInertia, double[/* 9 */] oldInertia, HlaTimeStamp timeStamp, HlaLogicalTime logicalTime);
    ...
    * @param logicalTime The logical time when the update was initiated.
    */
    void inertiaRateUpdated(HlaDynamicalEntity dynamicalEntity, double[/* 9 */] inertiaRate, boolean validOldInertiaRate, double[/* 9 */] oldInertiaRate, HlaTimeStamp timeStamp, HlaLogicalTime logicalTime);
    ...
    * @param logicalTime The logical time when the update was initiated.
    */
    void nameUpdated(HlaDynamicalEntity dynamicalEntity, String name, boolean validOldName, String oldName, HlaTimeStamp timeStamp, HlaLogicalTime logicalTime);
    ...
    * @param logicalTime The logical time when the update was initiated.
    */
    void typeUpdated(HlaDynamicalEntity dynamicalEntity, String type, boolean validOldType, String oldType, HlaTimeStamp timeStamp, HlaLogicalTime logicalTime);
    ...
    * @param logicalTime The logical time when the update was initiated.
    */
    void statusUpdated(HlaDynamicalEntity dynamicalEntity, String status, boolean validOldStatus, String oldStatus, HlaTimeStamp timeStamp, HlaLogicalTime logicalTime);
    ...
    * @param logicalTime The logical time when the update was initiated.
    */
    void parentReferenceFrameUpdated(HlaDynamicalEntity dynamicalEntity, String parentReferenceFrame, boolean validOldParentReferenceFrame, String oldParentReferenceFrame, HlaTimeStamp timeStamp, HlaLogicalTime logicalTime);
    ...
    * @param logicalTime The logical time when the update was initiated.
    */
    void stateUpdated(HlaDynamicalEntity dynamicalEntity, SpaceTimeCoordinateState state, boolean validOldState, SpaceTimeCoordinateState oldState, HlaTimeStamp timeStamp, HlaLogicalTime logicalTime);
    ...
    * @param logicalTime The logical time when the update was initiated.
    */
    void accelerationUpdated(HlaDynamicalEntity dynamicalEntity, double[/* 3 */] acceleration, boolean validOldAcceleration, double[/* 3 */] oldAcceleration, HlaTimeStamp timeStamp, HlaLogicalTime logicalTime);
...
projected.
    ...
    * @param logicalTime The logical time when the update was initiated.
    */
    void rotationalAccelerationUpdated(HlaDynamicalEntity dynamicalEntity, double[/* 3 */] rotationalAcceleration, boolean validOldRotationalAcceleration, double[/* 3 */] oldRotationalAcceleration, HlaTimeStamp timeStamp, HlaLogicalTime logicalTime);
    ...
    * @param logicalTime The logical time when the update was initiated.
    */
    void centerOfMassUpdated(HlaDynamicalEntity dynamicalEntity, double[/* 3 */] centerOfMass, boolean validOldCenterOfMass, double[/* 3 */] oldCenterOfMass, HlaTimeStamp timeStamp, HlaLogicalTime logicalTime);
    ...
    * @param logicalTime The logical time when the update was initiated.
    */
    void bodyWrtStructuralUpdated(HlaDynamicalEntity dynamicalEntity, AttitudeQuaternion bodyWrtStructural, boolean validOldBodyWrtStructural, AttitudeQuaternion oldBodyWrtStructural, HlaTimeStamp timeStamp, HlaLogicalTime logicalTime);
    ...
    * @param logicalTime The logical time when the update was initiated.
    */
    void producingFederateUpdated(HlaDynamicalEntity dynamicalEntity, HlaDynamicalEntityAttributes.Attribute attribute, HlaFederateId oldProducingFederate, HlaFederateId newProducingFederate, HlaTimeStamp timeStamp, HlaLogicalTime logicalTime);

   /**
    * An abstract adapter class that implements the HlaDynamicalEntityValueListener interface with empty methods.
    * It might be used as a base class for a listener.
    */
    public abstract static class Adapter implements HlaDynamicalEntityValueListener {
        public void forceUpdated(HlaDynamicalEntity dynamicalEntity, double[/* 3 */] force, boolean validOldForce, double[/* 3 */] oldForce, HlaTimeStamp timeStamp, HlaLogicalTime logicalTime) {}
        public void torqueUpdated(HlaDynamicalEntity dynamicalEntity, double[/* 3 */] torque, boolean validOldTorque, double[/* 3 */] oldTorque, HlaTimeStamp timeStamp, HlaLogicalTime logicalTime) {}
        public void massUpdated(HlaDynamicalEntity dynamicalEntity, double mass, boolean validOldMass, double oldMass, HlaTimeStamp timeStamp, HlaLogicalTime logicalTime) {}
        public void massRateUpdated(HlaDynamicalEntity dynamicalEntity, double massRate, boolean validOldMassRate, double oldMassRate, HlaTimeStamp timeStamp, HlaLogicalTime logicalTime) {}
        public void inertiaUpdated(HlaDynamicalEntity dynamicalEntity, double[/* 9 */] inertia, boolean validOldInertia, double[/* 9 */] oldInertia, HlaTimeStamp timeStamp, HlaLogicalTime logicalTime) {}
        public void inertiaRateUpdated(HlaDynamicalEntity dynamicalEntity, double[/* 9 */] inertiaRate, boolean validOldInertiaRate, double[/* 9 */] oldInertiaRate, HlaTimeStamp timeStamp, HlaLogicalTime logicalTime) {}
        public void nameUpdated(HlaDynamicalEntity dynamicalEntity, String name, boolean validOldName, String oldName, HlaTimeStamp timeStamp, HlaLogicalTime logicalTime) {}
        public void typeUpdated(HlaDynamicalEntity dynamicalEntity, String type, boolean validOldType, String oldType, HlaTimeStamp timeStamp, HlaLogicalTime logicalTime) {}
        public void statusUpdated(HlaDynamicalEntity dynamicalEntity, String status, boolean validOldStatus, String oldStatus, HlaTimeStamp timeStamp, HlaLogicalTime logicalTime) {}
        public void parentReferenceFrameUpdated(HlaDynamicalEntity dynamicalEntity, String parentReferenceFrame, boolean validOldParentReferenceFrame, String oldParentReferenceFrame, HlaTimeStamp timeStamp, HlaLogicalTime logicalTime) {}
        public void stateUpdated(HlaDynamicalEntity dynamicalEntity, SpaceTimeCoordinateState state, boolean validOldState, SpaceTimeCoordinateState oldState, HlaTimeStamp timeStamp, HlaLogicalTime logicalTime) {}
        public void accelerationUpdated(HlaDynamicalEntity dynamicalEntity, double[/* 3 */] acceleration, boolean validOldAcceleration, double[/* 3 */] oldAcceleration, HlaTimeStamp timeStamp, HlaLogicalTime logicalTime) {}
        public void rotationalAccelerationUpdated(HlaDynamicalEntity dynamicalEntity, double[/* 3 */] rotationalAcceleration, boolean validOldRotationalAcceleration, double[/* 3 */] oldRotationalAcceleration, HlaTimeStamp timeStamp, HlaLogicalTime logicalTime) {}
        public void centerOfMassUpdated(HlaDynamicalEntity dynamicalEntity, double[/* 3 */] centerOfMass, boolean validOldCenterOfMass, double[/* 3 */] oldCenterOfMass, HlaTimeStamp timeStamp, HlaLogicalTime logicalTime) {}
        public void bodyWrtStructuralUpdated(HlaDynamicalEntity dynamicalEntity, AttitudeQuaternion bodyWrtStructural, boolean validOldBodyWrtStructural, AttitudeQuaternion oldBodyWrtStructural, HlaTimeStamp timeStamp, HlaLogicalTime logicalTime) {}
        public void producingFederateUpdated(HlaDynamicalEntity instance, HlaDynamicalEntityAttributes.Attribute attribute, HlaFederateId oldProducingFederate, HlaFederateId newProducingFederate, HlaTimeStamp timeStamp, HlaLogicalTime logicalTime) {}
    }
}
